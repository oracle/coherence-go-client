...
//	}
func (nm *NamedMapClient[K, V]) EntrySet(ctx context.Context) EntryPageIterator[K, V] {
...
//	    fmt.Println("Key:", *key)
//	}
func (nm *NamedMapClient[K, V]) KeySet(ctx context.Context) KeyPageIterator[K, V] {
...
//	}
func (nm *NamedMapClient[K, V]) Values(ctx context.Context) ValuePageIterator[K, V] {
	return newValuePageIterator[K, V](ctx, &nm.baseClient)
}
