...
COHERENCE_VERSION=22.06.5 PROFILES=,-jakarta,javax make clean generate-proto build-test-images test-e2e-standalone

echo "Coherence CE 22.06.5 with scope"
...
echo "Coherence CE 22.06.5 with SSL using env"
...
echo "Coherence CE 22.06.5 with SSL using options"
