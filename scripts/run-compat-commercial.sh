...
echo "Coherence GE 14.1.1.2206.5"
COHERENCE_VERSION=14.1.1-2206-5 COHERENCE_GROUP_ID=com.oracle.coherence make clean generate-proto build-test-images test-e2e-standalone
