...
COHERENCE_BASE_IMAGE=gcr.io/distroless/java17-debian12 PROFILES=,-jakarta,javax COHERENCE_GROUP_ID=com.oracle.coherence COHERENCE_VERSION=14.1.2-0-1-SNAPSHOT make clean generate-proto generate-proto-v1 build-test-images test-e2e-standalone

COHERENCE_BASE_IMAGE=gcr.io/distroless/java11-debian12 PROFILES=,-jakarta,javax,queues COHERENCE_GROUP_ID=com.oracle.coherence COHERENCE_VERSION=14.1.2-0-1-SNAPSHOT make clean generate-proto generate-proto-v1 build-test-images test-e2e-standalone-queues
